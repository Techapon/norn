...
class ProfileEditCa extends StatelessWidget {
  const ProfileEditCa({super.key, required this.inputcontroller, required this.title, required this.hide, required this.userdocId, required this.type});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text("${title} : ",style: TextStyle(color: Colors.white,fontSize: 17.5),),
          SizedBox(width: 10,),
            ...
            children: [
              ...
              :Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: "-",
                    hintStyle: TextStyle(color: Colors.white70,fontSize: 17.5),
                    border: UnderlineInputBorder(
                      borderSide: BorderSide(color: Colors.white70),
                    ),
              ...
              Padding(
                ...
                child: IconButton(
                  ...
                  icon: Icon(Icons.edit,color: Colors.white,size: 17.5,),
                  onPressed: (){
                    hide
                    ? _changePasswordCa(
                      context: context,
                    ...
                    children: [
                      Expanded(
                        child: TextButton(
                          ...
                          child: Text("Cancle",style:  TextStyle(fontSize: 17.5),)
                        ),
                      ),
                      ...
                      Expanded(
                        child: TextButton(
                          ...
                          child: Text("Confirm",style: TextStyle(fontSize: 17.5),)
                        ),
                      ),
                    ],
                  )
