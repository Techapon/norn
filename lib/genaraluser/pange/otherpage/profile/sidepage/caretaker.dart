                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          SizedBox(width: 20,),
                          Icon(Icons.people_alt,color:Colors.black,size: 75,)
                        ],
                      ),
                              ...
                              children: [
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text("Cared for by",style: TextStyle(color: BgColor.Bg2Gradient.color_code,fontSize: 32,fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
                                      ...
                                      Text("person",style: TextStyle(color: BgColor.Bg2Gradient.color_code.withOpacity(0.7),fontSize: 25,fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
                                    ],
                                  ),
                                )
                              ],
