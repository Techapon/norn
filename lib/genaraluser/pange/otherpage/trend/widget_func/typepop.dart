  ...
  Widget build(BuildContext context) {
    ...
    return FilledButton(
      ...
      child: Row(
        ...
        children: [
          Text("${textLabel[0]}",style: GoogleFonts.itim(color: typetitle[0], fontSize: 17.5,fontWeight: FontWeight.bold),),
          Text("${textLabel[1]}",style: GoogleFonts.itim(color: typetitle[1], fontSize: 17.5,fontWeight: FontWeight.bold),),
          SizedBox(width: 7.5,),
          Icon(Icons.open_in_new_rounded,color: Colors.black,size: 23.5,),
        ],
      ),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text("Snore",style:  GoogleFonts.itim(color: Colors.black,fontSize: 25),),
          ),
          ...
          Padding(
            padding: EdgeInsetsGeometry.symmetric(horizontal: 10),
            child: Text("Undetected",style:  GoogleFonts.itim(color: Colors.black,fontSize: 25),),
          ),
          ...
          Padding(
            padding: EdgeInsetsGeometry.symmetric(horizontal: 10),
            child: Text("Quiet",style:  GoogleFonts.itim(color: Colors.black,fontSize: 25),),
          ),
          ...
          Padding(
            padding: EdgeInsetsGeometry.symmetric(horizontal: 10),
            child: Text("Sleep",style:  GoogleFonts.itim(color: Colors.black,fontSize: 25),),
          ),
        ...
        Expanded(
          child: FilledButton(
            ...
            child: Container(
              ...
              color: Colors.transparent,
              child: Text("${label} ${isActive ? '(Selected)' : '' }",style:  GoogleFonts.itim(color: Colors.black),),
            ),
          ),
        ),
      ],
