...
import 'package:nornsabai/genaraluser/pange/otherpage/profile/sidepage/account.dart';
    ...
    try {
      ...
      if (GeneralUser.exists) {
        ...
        return {
          ...
          "caretaker": userDoc["caretaker"],
          "request": userDoc["request"],
          "alarm": userDoc["alarm"],
              ...
              child: Column(
                children: [
                  ...
                  settingElement(
                    ...
                    onclick: (){
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => Account(userDocId: userDocId, userdata: userData,)));
                    },
                    iconSize: 35,
                    titleSize: 17,
                  ),
