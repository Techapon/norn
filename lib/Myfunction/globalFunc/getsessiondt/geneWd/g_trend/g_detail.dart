      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              // Icon
              detailIcon(Icon(Icons.calendar_today_outlined,size: 40, color: Colors.black)),
          ...
          Row(
            ...
            children: [
              ...
              detailIcon(Icon(Icons.list,size: 40, color: Colors.black)),
              SizedBox(width: 8),
              Text(
                'Used ${metrics.sessionCount} ',
                style: GoogleFonts.itim(fontSize: 20,color: headColor[1],fontWeight: FontWeight.w600,),
              ),
              Text(
                'time${metrics.sessionCount > 1 ? 's' : ''} this ${metrics.preroid}',
                style: GoogleFonts.itim(fontSize: 20,color: headColor[0],fontWeight: FontWeight.w600,),
              ),
